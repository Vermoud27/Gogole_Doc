...
public class DiffMerger2 {

    public static String mergeStrings(String str1, String str2, String ip1, String ip2) {
        // Diviser les chaînes en lignes
        List<String> lines1 = filterLines(Arrays.asList(str1.split("\n")));
        List<String> lines2 = filterLines(Arrays.asList(str2.split("\n")));
